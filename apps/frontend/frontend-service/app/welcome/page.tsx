    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full h-full max-w-sm space-y-8">
        ...
        <div className="relative flex justify-center items-end space-x-4 py-6">
          <button 
            className="relative text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-200 hover:scale-105"
            style={{
          ...
          <button 
            className="relative text-white font-bold py-3 px-8 rounded-full transform -translate-y-2 shadow-lg transition-all duration-200 hover:scale-105"
            style={{
              background: `radial-gradient(circle at center, #554099, #3d2d73)`,
              boxShadow: '0 8px 16px rgba(85, 64, 153, 0.3), 0 4px 8px rgba(0, 0, 0, 0.2)'
            }}
