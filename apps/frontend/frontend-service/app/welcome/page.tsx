...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white flex flex-col px-4 pb-[max(env(safe-area-inset-bottom),16px)] pt-4">
      <div className="w-full max-w-sm mx-auto flex-1 flex flex-col justify-between  pt-18">
        {/* Header */}
        <div className="text-center">
          <h1 className="text-5xl md:text-5xl font-bold text-[#554099] mt-10">swipick</h1>
        </div>

        {/* Middle: tagline, logos, 1-X-2, dots */}
        <div className="flex flex-col items-center justify-center">
          <p className="text-black text-base md:text-lg font-medium mt-1 mb-12 text-center">
          ...
          <div className="relative flex justify-center items-end space-x-8 py-6">
            <button
        ...
        <div className="pt-2 flex flex-col items-center justify-center pb-[150px]">
          <Button
            onClick={handleLogin}
            variant="primary"
            // fullWidth
            className="text-white font-semibold py-5 px-35 text-base flex items-center justify-center mb-3"
          >
            Login
          </Button>
          ...
          <Button
            ...
            variant="secondary"
            // fullWidth
            className="text-black font-semibold py-5 px-32 text-base flex items-center justify-center"
          >
            Registrati
          </Button>
        </div>
